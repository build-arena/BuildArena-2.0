...
def descriptor(self: Block) -> str:
    """Horizontal angle of blade axis vs forward; outboard tip along local +Z from center."""
    ...
    if axis_norm <= 1e-9:
        return "Propeller blade axis is degenerate."
    ...
    return (
        f"Blade horizontal angle of attack (chord projection vs forward): {horizontal_angle_text}. "
